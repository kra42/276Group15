...
class CreateCropViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        btnNumberOfRooms.setTitle("Rooms Selected: \(indexPath.row + 1)", for: .normal)
